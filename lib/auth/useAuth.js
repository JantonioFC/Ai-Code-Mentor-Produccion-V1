...
export function AuthProvider({ children }) {
  ...
  const value = {
    ...
    signOut,
    checkSession,
    getValidInternalToken: async () => {
      // Para la integración Next.js con cookies httpOnly, el navegador
      // ya envía la cookie de sesión en las peticiones fetch de la misma UI.
      // Retornamos un string dummy para que el form no arroje error.
      // El backend verificará la cookie real.
      return 'cookie-auth-active';
    }
  };
