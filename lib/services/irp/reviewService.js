...
export async function getReviewDetails(reviewId) {
    ...
    return {
        ...
        reviewer_info: {
            review_date: review ? review.submitted_at : request.created_at
        },
        recomendacion: review ? review.recomendacion : 'pending',
        calificacion_general: review ? review.calificacion_general : null,
        tiempo_revision_horas: review ? review.tiempo_revision_horas : null,
        mensaje_tutor: review ? review.mensaje_tutor : null,
        feedback: review ? {
