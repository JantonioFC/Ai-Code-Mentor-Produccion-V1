...
export class ModelDiscovery {
  ...
  async discover(forceRefresh = false) {
    if (process.env.E2E_TEST_MODE === 'true' || process.env.NEXT_PUBLIC_E2E_TEST_MODE === 'true') {
      console.log('[ModelDiscovery] E2E_TEST_MODE activo. Retornando modelos conocidos (mock).');
      return KNOWN_MODELS;
    }
